...
// modificato dal D.Lgs 101/2018 e Codice del Consumo (D.Lgs 206/2005).
// NON sostituiscono una consulenza legale: far revisionare da un professionista
// e completare i punti segnati [DA COMPLETARE].
...
4. PACCHETTI, PREZZI E PAGAMENTI
4.1 Le lezioni sono erogate tramite pacchetti (a ore, mensili o a consumo) le cui condizioni economiche, la durata e la scadenza sono comunicate al momento dell'acquisto.
4.2 Le ore incluse nel pacchetto devono essere utilizzate entro la data di scadenza indicata; salvo diverso accordo scritto, le ore non utilizzate alla scadenza non sono rimborsabili.
4.3 I pagamenti possono avvenire in contanti, bonifico, POS o assegno. Su richiesta viene emessa fattura.
[DA COMPLETARE: eventuali politiche di rimborso specifiche, acconti, penali]
...
5.3 La lezione prenotata e non disdetta nei termini comporta comunque lo scalo delle ore dal pacchetto. [DA COMPLETARE: confermare o modificare questa politica]
...
d) Eventuali informazioni su bisogni educativi particolari, comunicate volontariamente dalla famiglia: si tratta di dati che possono rientrare nelle categorie particolari ex art. 9 GDPR e sono trattati solo con consenso esplicito e per adeguare l'attività didattica;
...
Il conferimento dei dati di cui alle lettere a)-c) è necessario: senza di essi non è possibile erogare il servizio.
...
- Le ore che restano nel tuo pacchetto
