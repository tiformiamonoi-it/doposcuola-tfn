  ...
  <div class="min-h-screen bg-white">
    ...
    <header class="fixed top-0 left-0 right-0 h-16 bg-tfn-500 flex items-center justify-between px-4 z-40">
      ...
      <div class="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
        <span class="text-white text-xs font-semibold">G</span>
      </div>
    </header>
...
const navItems = [
  { icon: 'i-heroicons-home',          label: 'Home',    route: '/portale' },
  { icon: 'i-heroicons-calendar-days', label: 'Prenota', route: '/portale/prenota' },
  { icon: 'i-heroicons-document-text', label: 'Note',    route: '/portale/note' },
  { icon: 'i-heroicons-user',          label: 'Profilo', route: '/portale/profilo' },
]
