...
async function salvaModifica() {
  ...
  try {
    await $fetch(`/api/students/${id}`, {
      ...
      body: {
        ...datiModifica,
        classe:          datiModifica.classe          || undefined,
        scuola:          datiModifica.scuola          || undefined,
        studentPhone:    datiModifica.studentPhone    || undefined,
        studentEmail:    datiModifica.studentEmail    || undefined,
        parentName:      datiModifica.parentName      || undefined,
        parentPhone:     datiModifica.parentPhone     || undefined,
        parentEmail:     datiModifica.parentEmail     || undefined,
        parentIndirizzo: datiModifica.parentIndirizzo || undefined,
        parentCitta:     datiModifica.parentCitta     || undefined,
        parentCap:       datiModifica.parentCap       || undefined,
        parentCF:        datiModifica.parentCF        || undefined,
        bisogniSpeciali: datiModifica.bisogniSpeciali || undefined,
        note:            datiModifica.note            || undefined,
      },
    })
